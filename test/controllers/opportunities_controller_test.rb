...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { ministry: @opportunity.ministry, user_id: @opportunity.user_id, what: @opportunity.what, when: @opportunity.when, where: @opportunity.where, who: @opportunity.who }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { ministry: @opportunity.ministry, user_id: @opportunity.user_id, what: @opportunity.what, when: @opportunity.when, where: @opportunity.where, who: @opportunity.who }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
