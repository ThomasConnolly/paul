...
# This is an autogenerated file for dynamic methods in `InviteMailer`.
# Please instead update this file by running `bin/tapioca dsl InviteMailer`.
...
class InviteMailer
  class << self
    ...
    def invitation_instructions; end
