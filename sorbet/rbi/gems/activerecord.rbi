...
module ActiveRecord::Querying
  ...
  def async_find_by_sql(sql, binds = nil, preparable: nil, &block); end
  def async_ids(*, **, &); end
...
class ActiveRecord::ConnectionAdapters::ConnectionHandler
  ...
  def retrieve_connection_pool(connection_name, role: nil, shard: nil); end
...
module ActiveRecord::Locking::Optimistic::ClassMethods
  def define_attribute(name, cast_type, **); end
  def inherited(base); end
...
module ActiveRecord::Encryption::EncryptableRecord::ClassMethods
  ...
  def encrypt_attribute(name, key_provider: nil, key: nil, deterministic: nil, support_unencrypted_data: nil, downcase: nil, ignore_case: nil, previous: nil, **context_properties); end
  def encrypts(*names, key_provider: nil, key: nil, deterministic: nil, support_unencrypted_data: nil, downcase: nil, ignore_case: nil, previous: nil, **context_properties); end
...
module ActiveRecord::AttributeMethods::Serialization::ClassMethods
  ...
  def serialize(attr_name, class_name_or_coder = nil, coder: nil, type: nil, yaml: nil, **options); end
...
module ActiveRecord::Batches
  ...
  def in_batches(of: nil, start: nil, finish: nil, load: nil, error_on_ignore: nil, order: nil, use_ranges: nil, &block); end
end
class ActiveRecord::Batches::BatchEnumerator
  ...
  def finish; end
  def initialize(relation:, of: nil, start: nil, finish: nil, order: nil, use_ranges: nil); end
  def relation; end
  def start; end
  def update_all(updates); end
  include Enumerable
...
class ActiveRecord::Associations::CollectionAssociation < ActiveRecord::Associations::Association
  ...
  def add_to_target(record, skip_callbacks: nil, replace: nil, &block); end
  def build(attributes = nil, &block); end
  ...
  def replace_on_target(record, skip_callbacks, replace:, inversing: nil); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::TypeMetadata < Anonymous_Delegator_29
  extend ActiveRecord::ConnectionAdapters::Deduplicable::ClassMethods
  include ActiveRecord::ConnectionAdapters::Deduplicable
end
