...
class Fog::Collection < Array
  ...
  def from(*args, **); end
  def hash(*args, **); end
  def in_groups(*args, **); end
  def in_groups_of(*args, **); end
  def include?(*args, **); end
  def including(*args, **); end
  def index(*args, **); end
  def initialize(attributes = nil); end
  def inquiry(*args, **); end
  def insert(*args, **); end
  def inspect; end
...
class Fog::Cache
  ...
  def self.safe_class_path(klass); end
  def self.valid_for_load?(path); end
  def self.write_metadata(h); end
  def self.yaml_load(path); end
end
...
module Fog::Provider
  ...
  def self.underscore_name(string); end
