...
module Vips
  ...
  def self.block_untrusted(enabled); end
  ...
  def self.vips_block_untrusted_set(*arg0); end
  ...
  def self.vips_operation_block_set(*arg0); end
  ...
  def vips_block_untrusted_set(*arg0); end
  ...
  def vips_operation_block_set(*arg0); end
